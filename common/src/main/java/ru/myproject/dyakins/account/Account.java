...
public class Account {
    ...
    private Account(AccountBuilder builder) {
        ...
        this.additionInfo = builder.additionInfo;
    ...
    public String toString() {
        ...
        sb.append(", additionInfo='").append(additionInfo).append('\'');
    ...
    public static class AccountBuilder {
        ...
        public AccountBuilder setIcq(int icq) {
            this.icq = icq;
            return this;
        }
        ...
        public AccountBuilder setAdditionInfo(String additionInfo) {
            this.additionInfo = additionInfo;
            return this;
        }
